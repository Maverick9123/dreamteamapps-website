...
const apps = [
  ...
  },
  {
    id: "searchquest",
    name: "Search Quest",
    tagline: "Find the Right Contact, Fast.",
    description: "Flexible contact lookup by name, phone, email, or address. Get clean contact and address reports in seconds, with Siri voice search. Personal-use lookup — simple, fast, and privacy-respecting.",
    emoji: "🔍",
    icon: Search,
    ...
    badge: "LIVE // App Store",
    status: "ONLINE",
    features: ["Name / Phone / Email / Address Search", "Full Contact & Address Reports", "Siri Voice Search", "Saved Reports Vault", "Alerts & Monitoring"],
    appStoreUrl: "https://apps.apple.com/us/app/search-quest/id6789556151",
    code: "v1.0.0",
  },
  {
    id: "savenote",
    name: "SaveNote",
    tagline: "Speak It. Save It. Done.",
    description: "Hands-free voice notes, grocery lists, appointments, and daily reminders — organized into categories that make sense. Designed for people who'd rather speak than type. Notes stay private, right on your device.",
    emoji: "🎙️",
    icon: Mic,
    glowColor: "rgba(59,130,246,0.3)",
    borderColor: "border-blue-500/40",
  ...
  },
  {
    ...
    appStoreUrl: "https://apps.apple.com/us/app/gigstand-charts-setlists/id6788226390",
    code: "v1.1.0",
  },
  {
    id: "appsupportdesk",
